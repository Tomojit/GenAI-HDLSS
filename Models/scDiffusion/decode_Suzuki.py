...
def decode_seed(seed_num, num_genes=22206, hidden_dim=128):
    npz_path = f"output/scDiffusion/Suzuki/Suzuki_seed{seed_num}/samples.npz"
    vae_path = "output/VAE/Suzuki/model_seed=42_step=99999.pt"
    ...
    out_path = f"output/scDiffusion/Suzuki/suzuki_synthetic_seed{seed_num}.csv"
