...
def decode_seed(seed_num, num_genes=22283, hidden_dim=128):
    npz_path = f"output/scDiffusion/breastCancer/breastCancer_seed{seed_num}/samples.npz"
    vae_path = "output/VAE/breastCancer/model_seed=42_step=99999.pt"
    ...
    out_path = f"output/scDiffusion/breastCancer/breastCancer_synthetic_seed{seed_num}.csv"
