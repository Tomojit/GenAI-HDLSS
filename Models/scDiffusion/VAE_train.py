...
def train_vae(args, return_model=False):
    ...
    if args["state_dict"] not in [None, "", "None"]:
        filenames = {}
        checkpoint_path = {
...
def parse_arguments():
    ...
    parser.add_argument("--state_dict", type=str, default="guided-diffusion/scimilarity-main/models/annotation_model_v1")  # if pretrain
    ...
    # parser.add_argument('--name', type=str, default='tabula_muris')
